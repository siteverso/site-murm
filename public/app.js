import { formatDateTime, getRelevanceColumnDefinitions, getSexColumnDefinitions, hasUnreadMessages } from '/app-utils.mjs';
...
async function loadClassicScript(src) {
  await new Promise((resolve, reject) => {
    ...
    script.src = `${src}?v=20260712-relevance-columns-1`;
    script.async = false;
