...
const scripts = ["/js/core/runtime.js", "/js/user/user.js", "/js/posts/murmur-pulse.js", "/js/posts/posts-and-replies.js", "/js/feed/feed-renderer.js", "/js/feed/card-deck.js", "/js/feed/random-murmur.js", "/js/feed/feed-interactions.js", "/js/ui/ui.js", "/js/profile/profile.js", "/js/auth/auth.js", "/js/directs/directs.js", "/js/core/bootstrap.js"];

async function loadClassicScript(src) {
  await new Promise((resolve, reject) => {
    const script = document.createElement('script');
    script.src = `${src}?v=20260713-card-deck-tinder-glow-1`;
    script.async = false;
