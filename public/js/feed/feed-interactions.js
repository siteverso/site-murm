...
function renderPublishedReplyReceipt(parentId, reply, replyId) {
    ...
    const href = `/perfil/${encodeURIComponent(author)}?murmurio=${encodeURIComponent(replyId)}`;
...
async function revealPublishedReply(replyId, parentId, submittedText = '') {
    ...
    return renderPublishedReplyReceipt(parentId, reply, replyId);
}
